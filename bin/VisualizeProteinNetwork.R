...
query <- "
START n=node(*) MATCH (n)-[r]->(m) RETURN n.ClusterID AS from, m.ClusterID AS to;
"
...
# Save as PDF & PNG
pdf(file="./figures/ProteinNetworkDiagramClusters.pdf",
width=8,
height=8)
  a <- dev.cur()
  png(file="./figures/ProteinNetworkDiagramClusters.png",
  width=8,
  height=8,
  units="in",
  res=800)
...
pdf(file="./figures/ProteinNetworkDiagram.pdf",
width=8,
height=8)
  a <- dev.cur()
  png(file="./figures/ProteinNetworkDiagram.png",
  width=8,
  height=8,
  units="in",
  res=800)
