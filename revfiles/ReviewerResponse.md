...
*We fixed the error, and made the causes for the sample size clearer in the text as well as the figure legends. Thank you for pointing this out.* **LINES 200 - 202; FIGURE LEGEND 2**

* Figure 3A. Not clear why only 8 data points are available if Minot et al. report 15 samples from 5 individuals.

*We only used the subset of data points that had temporal data spaced approximately the same distance apart. We made this clearer in the text.* **LINES 191 - 192; 224 - 225; FIGURE LEGEND 1,2**
...
*We made this information clearer in the text.* **LINES 229 - 230; FIGURE LEGEND 3**
...
*Here we are reporting the accuracy for those values that were scored. Pairs without scores were omitted from this analysis, and we instead only focused on those that were scored. We have clarified this point.* **SEE LINES 145 - 146; FIGURE LEGEND 1**
...
*We added these values to the results section of the manuscript so that the reader can access this information.* **LINES 155 - 165**
